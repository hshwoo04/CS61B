...
public class WeirdList {
    ...
    public static final WeirdList EMPTY =
        new int[];  // REPLACE THIS LINE WITH THE RIGHT ANSWER.
     ...
     *  starts with THIS. */
    public int length() {
        return this.length;  // REPLACE THIS LINE WITH THE RIGHT ANSWER.
    }
    ...
    public WeirdList map(IntUnaryFunction func) {
        ...
        head = apply(this.head);
        tail  = this.tails.map(func);

        return this;  // REPLACE THIS LINE WITH THE RIGHT ANSWER.
    }
